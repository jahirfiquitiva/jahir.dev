...
date: '2024-01-04'
color: '#A47057'
hero: astro-reading-time/hero.jpg
excerpt: An alternative way to calculate reading time without full blog post rendering
---
...
Following, the [official docs](https://docs.astro.build/en/recipes/reading-time/) recipe, first you need to install 2 packages:
