...
With the code we have, we can already start allowing users contacting us and us receiving emails. Anyway, there are some user experience improvements that we can do.
