...
<video width="100%" autoplay="autoplay" loop muted style={{ pointerEvents: 'none' }}>
  <source src="/static/images/blog/building-website-scratch-22/same-same.mp4" type="video/mp4" />
</video>
...
then aimed for the average which is `656px`, but decided to go with the more *interesting* value
of `666px` 😅😈
...
<ImageComparison
  ...
  firstImage={
    '/static/images/blog/building-website-scratch-22/toolbar-old.png'
  }
...
<ImageComparison
  ...
  firstImage={
    '/static/images/blog/building-website-scratch-22/footer-old.png'
  }
  secondImageAlt={'New website footer design'}
  secondImage={
    '/static/images/blog/building-website-scratch-22/footer-new.png'
  }
  description={
...
<br />
<video width="100%" autoplay="autoplay" loop muted style={{ pointerEvents: 'none' }}>
  <source src="/static/images/blog/building-website-scratch-22/footer-now-playing.mp4" type="video/mp4" />
</video>
...
<Grid>
<GridColumn>
  ![Link with focus state](/static/images/blog/building-website-scratch-22/focused-link.png)
</GridColumn>
<GridColumn>
  ![Button with focus state](/static/images/blog/building-website-scratch-22/focused-button.png)
</GridColumn>
</Grid>
...
<ImageComparison
  ...
  firstImage={
    '/static/images/blog/building-website-scratch-22/share-old.png'
  }
  secondImageAlt={'New website share action'}
  secondImage={
    '/static/images/blog/building-website-scratch-22/share-new.png'
  }
  description={
...
motivate more people to sponsor me.
...
<ImageComparison
  ...
  description={
    'Previous dashboard grid (left) vs New dashboard grid (right).'
  }
/>
...
Additionally, I moved from PlanetScale to [Railway](https://railway.app/?referralCode=Ri5XbE) for hosting
...
At this time, I don’t really have plans to start from scratch for my website 😅 It definitely takes a lot of time and effort. Anyway, now I’m much more happy with the tech stack, the project structure and the design, so I hope that future updates are much easier to work on.

I hope you enjoyed this post and the different updates; if so, please click on those reaction buttons and share it with your friends! 😁

> Special thanks to [Patryk Michalik](https://patrykmichalik.com/) who was really kind and helpful providing feedback and ideas while I worked on this update.
