...
<ImageComparison
  ...
  firstImage={'/media/blog/website-redesign/toolbar-before.png'}
  secondImageAlt={'Toolbar now'}
  secondImage={'/media/blog/website-redesign/toolbar-after.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/website-redesign/projects-before.png'}
  secondImageAlt={'Projects cards now'}
  secondImage={'/media/blog/website-redesign/projects-after.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/website-redesign/blog-before.png'}
  secondImageAlt={'Blog now'}
  secondImage={'/media/blog/website-redesign/blog-after.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/website-redesign/blog-footer-before.png'}
  secondImageAlt={'Blog footer now'}
  secondImage={'/media/blog/website-redesign/blog-footer-after.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/website-redesign/footer-before.png'}
  secondImageAlt={'Footer now'}
  secondImage={'/media/blog/website-redesign/footer-after.png'}
  description={
