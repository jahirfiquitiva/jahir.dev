...
<ImageComparison
  ...
  firstImage={'/media/blog/building-website-scratch-22/toolbar-old.png'}
  secondImageAlt={'New website toolbar design'}
  secondImage={'/media/blog/building-website-scratch-22/toolbar-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/building-website-scratch-22/footer-old.png'}
  secondImageAlt={'New website footer design'}
  secondImage={'/media/blog/building-website-scratch-22/footer-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/building-website-scratch-22/share-old.png'}
  secondImageAlt={'New website share action'}
  secondImage={'/media/blog/building-website-scratch-22/share-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/building-website-scratch-22/inspiration-old.png'}
  secondImageAlt={'New website inspiration grid'}
  secondImage={'/media/blog/building-website-scratch-22/inspiration-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/media/blog/building-website-scratch-22/dashboard-old.png'}
  secondImageAlt={'New website dashboard grid'}
  secondImage={'/media/blog/building-website-scratch-22/dashboard-new.png'}
