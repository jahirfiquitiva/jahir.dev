...
<ImageComparison
  ...
  firstImage={'/blog/building-website-scratch-22/toolbar-old.png'}
  secondImageAlt={'New website toolbar design'}
  secondImage={'/blog/building-website-scratch-22/toolbar-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/blog/building-website-scratch-22/footer-old.png'}
  secondImageAlt={'New website footer design'}
  secondImage={'/blog/building-website-scratch-22/footer-new.png'}
  description={
...
<Grid>
  <GridColumn>
    ![Link with focus state](/blog/building-website-scratch-22/focused-link.png)
  </GridColumn>
  <GridColumn>
    ![Button with focus
    state](/blog/building-website-scratch-22/focused-button.png)
  </GridColumn>
</Grid>
...
![Instagram Feed](/blog/building-website-scratch-22/insta-feed.png)
...
<ImageComparison
  ...
  firstImage={'/blog/building-website-scratch-22/share-old.png'}
  secondImageAlt={'New website share action'}
  secondImage={'/blog/building-website-scratch-22/share-new.png'}
  description={
    'Previous blog post actions (left) vs New blog post actions (right).'
  }
/>

![Browser share options](/blog/building-website-scratch-22/share-options.png)

#### Contact

For this one, I kept it simple and just updated the layout of the different links to kind of look like a table.

[![Contact page links and content](/blog/building-website-scratch-22/contact-page.png)](/contact)
...
[![Grid showing different hardware tools](/blog/building-website-scratch-22/hardware.png)](/uses)

Added another grid showing some of my favorite and most used apps on my MacBook

[![Grid showing different MacOS apps](/blog/building-website-scratch-22/apps.png)](/uses)

And finally, a cool simple section showcasing the different tools in the stack I used to build this website:

[![Grid showing the logos for the tech stack this website is built with](/blog/building-website-scratch-22/tech-stack.png)](/uses)
...
[![Partially visible table listing my sponsors](/blog/building-website-scratch-22/sponsors.png)](/donate)
...
<ImageComparison
  ...
  firstImage={'/blog/building-website-scratch-22/inspiration-old.png'}
  secondImageAlt={'New website inspiration grid'}
  secondImage={'/blog/building-website-scratch-22/inspiration-new.png'}
  description={
...
<ImageComparison
  ...
  firstImage={'/blog/building-website-scratch-22/dashboard-old.png'}
  secondImageAlt={'New website dashboard grid'}
  secondImage={'/blog/building-website-scratch-22/dashboard-new.png'}
...
![Railway database usage stats](/blog/building-website-scratch-22/railway-usage.png)
...
> ![Railway database usage is expensive](/blog/building-website-scratch-22/railway-expensive.png)
