...
const robot =
  'M19 10h-6V7.8c1.2-.4 2-1.5 2-2.8 0-1.7-1.3-3-3-3S9 3.3 9 5c0 1.3.8 2.4 2 2.8V10H5c-1.7 0-3 1.3-3 3v6c0 1.7 1.3 3 3 3h14c1.7 0 3-1.3 3-3v-6c0-1.7-1.3-3-3-3zm-7-6c.6 0 1 .4 1 1s-.4 1-1 1-1-.4-1-1 .4-1 1-1zm8 15c0 .6-.4 1-1 1H5c-.6 0-1-.4-1-1v-6c0-.6.4-1 1-1h14c.6 0 1 .4 1 1v6zM8.9 15.6c.1.1.1.3.1.4s0 .3-.1.4c-.1.1-.1.2-.2.3-.1 0-.1.1-.1.1-.1 0-.1.1-.2.1s-.1 0-.2.1H8c-.3 0-.5-.1-.7-.3-.2-.2-.3-.4-.3-.7 0-.1 0-.3.1-.4.1-.1.1-.2.2-.3.2-.2.6-.3.9-.3.1 0 .1 0 .2.1.1 0 .1 0 .2.1l.1.1c.1.1.2.2.2.3zm8 0c.1.1.1.3.1.4 0 .3-.1.5-.3.7-.2.2-.4.3-.7.3-.1 0-.3 0-.4-.1-.1 0-.2-.1-.3-.2-.2-.2-.3-.4-.3-.7 0-.1 0-.3.1-.4s.1-.2.2-.3c.1-.1.2-.2.3-.2.4-.2.8-.1 1.1.2.1.1.2.2.2.3z';

const lightning =
  'M11 23c-.1 0-.3 0-.4-.1-.4-.2-.6-.6-.6-1l.9-6.9H3c-.4 0-.7-.2-.9-.6-.2-.4-.1-.8.1-1.1l10-12c.3-.3.8-.4 1.2-.2.4.2.6.6.6 1L13.1 9H21c.4 0 .7.2.9.6.2.4.1.8-.1 1.1l-10 12c-.2.2-.5.3-.8.3zM5.1 13H12c.3 0 .6.1.7.3.2.2.3.5.2.8l-.6 4.6 6.4-7.7H12c-.3 0-.6-.1-.7-.3-.2-.2-.3-.5-.2-.8l.6-4.6L5.1 13z';
