...
The service I was using (for the contact and blog ideas forms) looks like if it was abandoned, there's no support and it even started failing
recently.
...
Anyways, the [contact page](/contact) is still available and includes links for different ways to [contact me](/contact)

## What's new?

Everything!
- My name in home page is clickable and will play an audio with the correct pronunciation of my name.
- Tailwind and Styled Components
- New projects cards
- New blog posts cards
- Music dashboard has evolved into a more complete dashboard
