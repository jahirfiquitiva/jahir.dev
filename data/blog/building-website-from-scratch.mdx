...
<Image
  src={'/static/images/blog/building-website-from-scratch/git-diff.png'}
  alt={'Image showing the git differences between my previous website and the new one'}
  width={324}
  height={78}
  layout={'responsive'}
/>
...
<Image
  src={'/static/images/blog/building-website-from-scratch/contact-page-preview.png'}
...
I found [lanyard](https://github.com/Phineas/lanyard/), and api that provides your discord activity information, and thought it was pretty cool to show all that activity in real time.
...
size. Here's what they used to look like:

<SimpleGrid className={'mb-16'}>
<SimpleGridColumn>

<Image
  src={'/static/images/blog/building-website-from-scratch/old-cards-issue-1.png'}
...
<Image
  src={'/static/images/blog/building-website-from-scratch/old-cards-issue-2.png'}
...
<Image
  src={'/static/images/blog/building-website-from-scratch/new-project-cards.png'}
...
<ImageComparison
  ...
  firstImage={
    '/static/images/posts/building-website-from-scratch/blog-cards-before.png'
  }
  secondImageAlt={'First iteration of blog posts cards design'}
  secondImage={
    '/static/images/posts/building-website-from-scratch/blog-cards-iteration.png'
  }
  description={
...
<ImageComparison
  ...
  secondImage={'/static/images/posts/building-website-from-scratch/blog-cards-now.png'}
  description={
