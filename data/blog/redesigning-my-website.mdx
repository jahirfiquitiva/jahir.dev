...
<ImageComparison
  ...
  description={'Toolbar before (left) and now (right). Slide over the image to view the differences'}
/>
...
<ImageComparison
  ...
  firstImage={'/static/images/posts/website-redesign/projects-before.png'}
  secondImageAlt={'Projects cards now'}
  secondImage={'/static/images/posts/website-redesign/projects-after.png'}
  description={'Projects cards before (left) and now (right). Slide over the image to view the differences'}
/>
...
<ImageComparison
  sliderPosition={0.4}
  firstImageAlt={'Blog before'}
  firstImage={'/static/images/posts/website-redesign/blog-before.png'}
  secondImageAlt={'Blog now'}
  secondImage={'/static/images/posts/website-redesign/blog-after.png'}
  description={'Blog before (left) and now (right). Slide over the image to view the differences'}
/>

<ImageComparison
  sliderPosition={0.4}
  firstImageAlt={'Blog footer before'}
  firstImage={'/static/images/posts/website-redesign/blog-footer-before.png'}
  secondImageAlt={'Blog footer now'}
  secondImage={'/static/images/posts/website-redesign/blog-footer-after.png'}
  description={'Blog footer before (left) and now (right). Slide over the image to view the differences'}
/>
...
<ImageComparison
  sliderPosition={0.3}
  firstImageAlt={'Footer before'}
  firstImage={'/static/images/posts/website-redesign/footer-before.png'}
  secondImageAlt={'Footer now'}
  secondImage={'/static/images/posts/website-redesign/footer-after.png'}
  description={'Footer before (left) and now (right). Slide over the image to view the differences'}
/>
